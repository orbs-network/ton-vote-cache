...
const DAOS_BATCH_SIZE = 3; 
const PROPOSALS_BATCH_SIZE = 3;

const UPDATE_DAOS_BATCH_SIZE = 3;
...
export class Fetcher {
    ...
    async init() {
        ...
        this.client = await TonVoteSdk.getClientV2(); // new TonClient({endpoint: "http://107.6.173.98/1/mainnet/toncenter-api-v2/jsonRPC"}) // working am3
